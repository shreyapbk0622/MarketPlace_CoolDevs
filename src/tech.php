...
// Fetch all Tech products
$product_query = $conn->prepare("SELECT * FROM products WHERE company = 'Tech'");
$product_query->execute();
$product_result = $product_query->get_result();

if ($product_result->num_rows === 0) {
    die("No Tech products available.");
}
?>
...
<body>
    ...
    <a href="top_tech.php" class="btn">Top 5 Visited Products</a>
